...
export default function Footer({ onNavClick }: FooterProps) {
  const socialLinks: SocialLink[] = [
    {
      name: 'GitHub',
      url: 'https://github.com/thenexhack',
      lordIcon: 'https://cdn.lordicon.com/jjxzcivr.json',
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/company/nexhack/',
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/thenexhack/',
      lordIcon: 'https://cdn.lordicon.com/tgyvxauj.json',
    ...
    {
      name: 'Discord',
      url: 'https://discord.gg/mKy2G9ye6F',
      lordIcon: 'https://cdn.lordicon.com/zvnxzuwv.json',
    ...
    {
      name: 'Twitter',
      url: 'https://x.com/thenexhack',
      lordIcon: 'https://cdn.lordicon.com/wlbymhoo.json',
      icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
    }
  ];
          ...
          <div className="footer-links-grid">
            ...
            <div className="footer-extra-links">
              <div className="footer-link-group">
                <h4>Resources</h4>
                <a href="./images/sponsors/NexHack_2.0_Sponsorship_Prospectus.pdf" className="footer-text-link" target="_blank" rel="noopener noreferrer">Sponsorship Brochure</a>
                <a href="./images/NexHack%202.0%20Code%20of%20Conduct.pdf" className="footer-text-link" target="_blank" rel="noopener noreferrer">Code of Conduct</a>
              </div>
              <div className="footer-link-group">
                <h4>Archives</h4>
                <a href="/nexhack1" className="footer-text-link">NexHack 1.0 Archive</a>
              </div>
            </div>
                ...
                >
                  {s.lordIcon
                    ? React.createElement('lord-icon', {
                        src: s.lordIcon,
                        trigger: 'loop',
                        colors: 'primary:#a0a0b0,secondary:#a0a0b0',
