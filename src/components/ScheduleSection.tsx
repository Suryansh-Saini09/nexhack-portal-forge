...
export const ScheduleSection = () => {
  ...
  const schedule = {
    day1: [
      ...
      { time: "11:00 AM", event: "Opening Cermony Start", location: "Main Auditorium", type: "ceremony" },
      { time: "1:00 PM", event: "Hacking Round 1 Starts", location: "Hacking Area", type: "hack" },
      { time: "2:30 PM", event: "Lunch", location: "Food court", type: "break" },
      { time: "3:30 PM", event: "Mentorship Round 1", location: "Hacking Area", type: "mentoring" },
      { time: "5:00 PM", event: "Refrenshment Break", location: "Food Court", type: "break" },
      { time: "6:00 PM", event: "Hacking Round 2 Start", location: "Hacking Area", type: "hack" },
      { time: "8:00 PM", event: "Dinner break", location: "Food Court", type: "break" },
      { time: "9:00 PM", event: "Activity Time", location: "C Block Ground", type: "break" },
      { time: "10:00 PM", event: "Hacking Round 3", location: "Hacking Area", type: "hack" },
    ...
    day2: [
      { time: "1:30 AM", event: "Hacking Round 4", location: "Hacking Area", type: "hack" },
      { time: "4:00 AM", event: "Mentorship Round 2", location: "F Block", type: "mentorship" },
      { time: "5:00 AM", event: "Hacking Round 4", location: "Hacking Area", type: "hack" },
      ...
      { time: "9:00 AM", event: "Announcement of Top 20 Teams", location: "Discord Channels/Whatsapp Group", type: "selection" },
      { time: "10:00 AM", event: "Final Presentation", location: "Main Auditorium", type: "presentation" },
      { time: "12:40 PM", event: "Lunch", location: "University Mess", type: "break" },
      { time: "1:30 PM", event: "Prize Distribution Ceremony", location: "Main Auditorium", type: "ceremony " },
      { time: "2:30 PM", event: "Closing Ceremony and Networking", location: "Main Auditorium", type: "ceremony and networking" },
    ]
  };
